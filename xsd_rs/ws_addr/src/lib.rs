...
// Generated from ws-addr.xsd hereon ---------------------------------

// pub type EndpointReference = EndpointReferenceType;
#[derive(Default, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "tns", namespace = "tns: http://www.w3.org/2005/08/addressing")]
...
// pub type ProblemHeader = AttributedAnyType;
#[derive(Default, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "tns", namespace = "tns: http://www.w3.org/2005/08/addressing")]
pub struct AttributedAnyType {}

impl Validate for AttributedAnyType {}
