...
use b2 as wsnt;
use soapenv as soapenv;
use xmlmime as xmime;
...
// Generated from onvif.xsd hereon ---------------------------------
...
// pub type StringList = StringList;
// pub type IntRange = IntRange;
// pub type IntList = IntList;
// pub type FloatRange = FloatRange;
// pub type FloatList = FloatList;
...
#[derive(PartialEq, Debug, YaSerialize, YaDeserialize)]#[yaserde(prefix = "tt", namespace = "tt: http://www.onvif.org/ver10/schema")]
...
pub struct RotateOptions {
    ...
    pub degree_list: Option<IntItems>,
...
pub struct VideoEncoder2ConfigurationOptions {
    ...
    pub gov_length_range: Option<IntList>,
    ...
    pub frame_rates_supported: Option<FloatList>,
...
// Audio Media Type and except for the audio types defined in the restriction).
// See also
#[derive(PartialEq, Debug, YaSerialize, YaDeserialize)]#[yaserde(prefix = "tt", namespace = "tt: http://www.onvif.org/ver10/schema")]
...
pub enum AudioEncodingMimeNames {
    #[yaserde(rename = "PCMU")]
    Pcmu,
    // AudioEncodingMimeName G726 is used to represent G726-16,G726-24,G726-32
    // and G726-40 defined in the IANA Media Types
    G726,
...
pub struct MetadataConfiguration {
    ...
    // Note that the streaming behavior is undefined if the list includes items
    // that are not part of the associated AnalyticsConfiguration.
    #[yaserde(prefix = "tt", rename = "AnalyticsEngineConfiguration")]
    ...
    #[yaserde(attribute, rename = "ShapePolygon")]
    pub shape_polygon: Option<bool>,
...
pub struct MetadataConfigurationOptions {
    ...
    #[yaserde(attribute, rename = "MaxContentFilterSize")]
    pub max_content_filter_size: Option<i32>,
}
...
pub struct EventCapabilities {
    ...
    // supported.
    #[yaserde(prefix = "tt", rename = "WSPausableSubscriptionManagerInterfaceSupport")]
...
pub struct RelayOutputSettings {
    ...
    pub delay_time: String, //NB: manually amended as Duration cannot handle empty values from Synology
...
pub struct PtzpresetTourPresetDetail {
    ...
    pub ptz_preset_tour_preset_detail_choice: ptz_preset_tour_preset_detail::PtzpresetTourPresetDetailChoice,
}
...
pub enum MoveAndTrackMethod {
    PresetToken,
    GeoLocation,
    #[yaserde(rename = "PTZVector")]
    Ptzvector,
    ObjectID,
    __Unknown__(String),
}

impl Default for MoveAndTrackMethod {
    fn default() -> MoveAndTrackMethod {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for MoveAndTrackMethod {}
...
impl Default for ImageSendingType {
    fn default() -> ImageSendingType {
        Self::__Unknown__("No valid variants".into())
    }
}

impl Validate for ImageSendingType {}
...
#[yaserde(prefix = "tt", namespace = "tt: http://www.onvif.org/ver10/schema")]
pub struct Config {
    // List of configuration parameters as defined in the corresponding
    // description.
...
pub mod config_description {
    ...
    pub struct MessagesType {
        // The topic of the message. For historical reason the element is named
        // ParentTopic, but the full topic is expected.
...
pub struct SupportedRules {
    ...
    #[yaserde(attribute, rename = "Limit")]
...
// pub type PolygonOptions = PolygonOptions;
#[derive(Default, PartialEq, Debug, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "tt", namespace = "tt: http://www.onvif.org/ver10/schema")]
pub struct PolygonOptions {
    ...
    // device does not support polygon regions. In this case, the points
    // provided in the Polygon element shall represent a rectangle.
    #[yaserde(prefix = "tt", rename = "RectangleOnly")]
    pub rectangle_only: Option<bool>,

    // Provides the minimum and maximum number of points that can be defined in
    // the Polygon.
    // If RectangleOnly is not set to true, this parameter is required.
    #[yaserde(prefix = "tt", rename = "VertexLimits")]
    pub vertex_limits: Option<IntRange>,
}

impl Validate for PolygonOptions {}
