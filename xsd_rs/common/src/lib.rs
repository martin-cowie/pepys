...
// Generated from common.xsd hereon ---------------------------------
...
// Length up to 64 characters. Token may be extended by intermediate terminal
// with adding prefix to make it global unique.
// The length should be within 36 characters for generating at local device. See
// "Remote Token" section in Resource Query specification.
...
pub struct ColorDescriptor {
    ...
    //NB: removed, as AnyType is problematic
    // #[yaserde(prefix = "tt", rename = "Extension")]
    // pub extension: Option<xs::AnyType>,
}
